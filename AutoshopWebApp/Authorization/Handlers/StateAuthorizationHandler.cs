...
{
    public class StateAuthorizationHandler
        : AuthorizationHandler<OperationAuthorizationRequirement, CarStateRef>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, 
            OperationAuthorizationRequirement requirement, CarStateRef resource)
        {

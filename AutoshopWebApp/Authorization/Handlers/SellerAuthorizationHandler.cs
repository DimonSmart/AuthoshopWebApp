...
{
    public class SellerAuthorizationHandler :
        AuthorizationHandler<OperationAuthorizationRequirement, ClientSeller>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, 
            OperationAuthorizationRequirement requirement, ClientSeller resource)
        {

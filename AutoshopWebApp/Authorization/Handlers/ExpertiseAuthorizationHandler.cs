...
{
    public class ExpertiseAuthorizationHandler
        : AuthorizationHandler<OperationAuthorizationRequirement, PoolExpertiseReference>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context,
            OperationAuthorizationRequirement requirement, PoolExpertiseReference resource)
        {

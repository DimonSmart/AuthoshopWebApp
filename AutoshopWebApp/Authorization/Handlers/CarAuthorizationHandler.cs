...
{
    public class CarAuthorizationHandler :
         AuthorizationHandler<OperationAuthorizationRequirement, Car>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context,
            OperationAuthorizationRequirement requirement, Car resource)
        {
